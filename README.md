...
We also acknowledge the open-source community for libraries like [PyTorch Lightning](https://github.com/Lightning-AI/pytorch-lightning), [segmentation_models.pytorch](https://github.com/qubvel-org/segmentation_models.pytorch), and [timm](https://github.com/huggingface/pytorch-image-models) which made this work possible.
